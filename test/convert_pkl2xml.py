...
import sys,os
exec(open("../examples/tree_convert_pkl2xml.py").read())
...
inputFile_Dir = "/home/binghuan/Work/TTHLep/TTHLep_RunII/ttH_hjtagger_xgboost/HjTagger/outputs/HwwSig_dart/weights/"
inputFile_Name = "HwwSig_dart_nogenhadTop_2018.pkl"
...
outputFile_Name = "test_XGBoost.weights"
...
features=['Jet25_bDiscriminator', 'Jet25_pt', 'Jet25_lepdrmin', 'Jet25_lepdrmax', 'Jet25_qg']
