...
void wSetBranchAddress(TTree* newtree){
   ...
   newtree->Branch("Jet25_isToptag", &Jet_isToptag);
   newtree->Branch("Jet25_axis2", &Jet_axis2); 
   newtree->Branch("Jet25_bDiscriminator", &Jet_bDiscriminator); 
   newtree->Branch("Jet25_bjdeta", &Jet_bjdeta); 
   newtree->Branch("Jet25_bjdphi", &Jet_bjdphi); 
   newtree->Branch("Jet25_bjdr", &Jet_bjdr); 
   newtree->Branch("Jet25_bjptratio", &Jet_bjptratio); 
   newtree->Branch("Jet25_chargedEmEnergyFraction", &Jet_chargedEmEnergyFraction); 
   newtree->Branch("Jet25_chargedHadronEnergyFraction", &Jet_chargedHadronEnergyFraction); 
   newtree->Branch("Jet25_chargedMultiplicity", &Jet_chargedMultiplicity); 
   newtree->Branch("Jet25_dilepdeta", &Jet_dilepdeta); 
   newtree->Branch("Jet25_dilepdphi", &Jet_dilepdphi); 
   newtree->Branch("Jet25_dilepdr", &Jet_dilepdr); 
   newtree->Branch("Jet25_dilepmetptratio", &Jet_dilepmetptratio); 
   newtree->Branch("Jet25_dilepptratio", &Jet_dilepptratio); 
   newtree->Branch("Jet25_electronEnergy", &Jet_electronEnergy); 
   newtree->Branch("Jet25_energy", &Jet_energy); 
   newtree->Branch("Jet25_eta", &Jet_eta); 
   newtree->Branch("Jet25_isFromH", &Jet_isFromH); 
   newtree->Branch("Jet25_isFromTop", &Jet_isFromTop); 
   newtree->Branch("Jet25_lepdetamax", &Jet_lepdetamax); 
   newtree->Branch("Jet25_lepdetamin", &Jet_lepdetamin); 
   newtree->Branch("Jet25_lepdphimax", &Jet_lepdphimax); 
   newtree->Branch("Jet25_lepdphimin", &Jet_lepdphimin); 
   newtree->Branch("Jet25_lepdrmax", &Jet_lepdrmax); 
   newtree->Branch("Jet25_lepdrmin", &Jet_lepdrmin); 
   newtree->Branch("Jet25_lepptratiomax", &Jet_lepptratiomax); 
   newtree->Branch("Jet25_lepptratiomin", &Jet_lepptratiomin); 
   newtree->Branch("Jet25_mass", &Jet_mass); 
   newtree->Branch("Jet25_matchId", &Jet_matchId); 
   newtree->Branch("Jet25_metptratio", &Jet_metptratio); 
   newtree->Branch("Jet25_mult", &Jet_mult); 
   newtree->Branch("Jet25_muonEnergyFraction", &Jet_muonEnergyFraction); 
   newtree->Branch("Jet25_neutralHadEnergyFraction", &Jet_neutralHadEnergyFraction); 
   newtree->Branch("Jet25_nonjdeta", &Jet_nonjdeta); 
   newtree->Branch("Jet25_nonjdilepdeta", &Jet_nonjdilepdeta); 
   newtree->Branch("Jet25_nonjdilepdphi", &Jet_nonjdilepdphi); 
   newtree->Branch("Jet25_nonjdilepdr", &Jet_nonjdilepdr); 
   newtree->Branch("Jet25_nonjdilepptratio", &Jet_nonjdilepptratio); 
   newtree->Branch("Jet25_nonjdphi", &Jet_nonjdphi); 
   newtree->Branch("Jet25_nonjdr", &Jet_nonjdr); 
   newtree->Branch("Jet25_nonjptratio", &Jet_nonjptratio); 
   newtree->Branch("Jet25_numberOfConstituents", &Jet_numberOfConstituents); 
   newtree->Branch("Jet25_pfCombinedCvsBJetTags", &Jet_pfCombinedCvsBJetTags); 
   newtree->Branch("Jet25_pfCombinedCvsLJetTags", &Jet_pfCombinedCvsLJetTags); 
   newtree->Branch("Jet25_pfCombinedInclusiveSecondaryVertexV2BJetTags", &Jet_pfCombinedInclusiveSecondaryVertexV2BJetTags); 
   newtree->Branch("Jet25_pfCombinedMVAV2BJetTags", &Jet_pfCombinedMVAV2BJetTags); 
   newtree->Branch("Jet25_pfDeepCSVCvsBJetTags", &Jet_pfDeepCSVCvsBJetTags); 
   newtree->Branch("Jet25_pfDeepCSVCvsLJetTags", &Jet_pfDeepCSVCvsLJetTags); 
   newtree->Branch("Jet25_pfJetProbabilityBJetTags", &Jet_pfJetProbabilityBJetTags); 
   newtree->Branch("Jet25_phi", &Jet_phi); 
   newtree->Branch("Jet25_photonEnergy", &Jet_photonEnergy); 
   newtree->Branch("Jet25_pt", &Jet_pt); 
   newtree->Branch("Jet25_ptD", &Jet_ptD); 
   newtree->Branch("Jet25_px", &Jet_px); 
   newtree->Branch("Jet25_py", &Jet_py); 
   newtree->Branch("Jet25_pz", &Jet_pz); 
   newtree->Branch("Jet25_qg", &Jet_qg); 
};
